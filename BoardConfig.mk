...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/d2xq/prebuilt/Image.gz-dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/d2xq/prebuilt/recoverydtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPSG26A003"
BOARD_MKBOOTIMG_ARGS += --recovery_dtbo $(BOARD_PREBUILT_DTBOIMAGE)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/d2xq/bootimg.mk
